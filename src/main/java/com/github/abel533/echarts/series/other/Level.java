...
public class Level implements Serializable {
    ...
    public com.github.abel533.echarts.series.other.Level label(ItemStyle label) {
        this.label = label;
        return this;
    }
    ...
    public com.github.abel533.echarts.series.other.Level itemStyle(ItemStyle itemStyle) {
    ...
    public com.github.abel533.echarts.series.other.Level visualDimension(Integer visualDimension) {
    ...
    public com.github.abel533.echarts.series.other.Level color(Object[] color) {
        this.color = color;
        return this;
    }
    ...
    public com.github.abel533.echarts.series.other.Level colorAlpha(Object[] colorAlpha) {
    ...
    public com.github.abel533.echarts.series.other.Level colorSaturation(Double colorSaturation) {
    ...
    public com.github.abel533.echarts.series.other.Level colorMappingBy(Object colorMappingBy) {
        this.colorMappingBy = colorMappingBy;
        return this;
    }

    public com.github.abel533.echarts.series.other.Level colorMappingBy(ColorMappingBy colorMappingBy) {
        this.colorMappingBy = colorMappingBy;
        return this;
    }
    ...
    public com.github.abel533.echarts.series.other.Level visibleMin(Double visibleMin) {
    ...
    public com.github.abel533.echarts.series.other.Level childrenVisibleMin(Double childrenVisibleMin) {
