...
public class Force implements Serializable {
    ...
    public com.github.abel533.echarts.series.other.Force initLayout(Object initLayout) {
        this.initLayout = initLayout;
        return this;
    }

    public com.github.abel533.echarts.series.other.Force initLayout(String initLayout) {
        this.initLayout = initLayout;
        return this;
    }

    public com.github.abel533.echarts.series.other.Force initLayout(Layout initLayout) {
        this.initLayout = initLayout;
        return this;
    }
    ...
    public com.github.abel533.echarts.series.other.Force repulsion(Integer repulsion) {
    ...
    public com.github.abel533.echarts.series.other.Force gravity(Integer gravity) {
    ...
    public com.github.abel533.echarts.series.other.Force edgeLength(Integer edgeLength) {
    ...
    public com.github.abel533.echarts.series.other.Force layoutAnimation(Boolean layoutAnimation) {
