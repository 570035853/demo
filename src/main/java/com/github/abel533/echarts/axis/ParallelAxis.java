...
@Getter
@Setter
public class ParallelAxis extends Axis<com.github.abel533.echarts.axis.ParallelAxis> {
    /**
     * 坐标轴的维度号
     */
    private Integer dim;
    ...
    public com.github.abel533.echarts.axis.ParallelAxis dim(Integer dim) {
        this.dim = dim;
        return this;
    }
    ...
    public com.github.abel533.echarts.axis.ParallelAxis parallelIndex(Integer parallelIndex) {
    ...
    public com.github.abel533.echarts.axis.ParallelAxis splitNumber(Integer splitNumber) {
    ...
    public com.github.abel533.echarts.axis.ParallelAxis nameLocation(NameLocation nameLocation) {
    ...
    public com.github.abel533.echarts.axis.ParallelAxis areaSelectStyle(AreaSelectStyle areaSelectStyle) {
    ...
    public com.github.abel533.echarts.axis.ParallelAxis nameTextStyle(NameTextStyle nameTextStyle) {
