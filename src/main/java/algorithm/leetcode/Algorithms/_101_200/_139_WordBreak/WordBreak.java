package algorithm.leetcode.Algorithms._101_200._139_WordBreak;
 ...
 * Created by jialei.zou on 2019/1/23 .
 ...
 Input: s = "algorithm.leetcode", wordDict = ["leet", "code"]
 Output: true
 Explanation: Return true because "algorithm.leetcode" can be segmented as "leet code".
 Example 2:
...
public class WordBreak {
    ...
    public static void main(String[] args) {
        System.out.println(wordBreak("algorithm/leetcode", Arrays.asList("leet","code" )));
