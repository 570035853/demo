 ...
 */
public class LineAndShapeDemo extends ApplicationFrame {

    public LineAndShapeDemo(final String title)
    {
        super(title);
    ...
    public static void main(final String[] args)
    {
        ...
        final LineAndShapeDemo demo = new LineAndShapeDemo("Line Chart Demo 5");
        demo.pack();
